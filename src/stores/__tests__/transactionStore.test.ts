...
describe('TransactionStore', () => {
  ...
  describe('createTransaction', () => {
    ...
    it('should throw error when category is missing', async () => {
      ...
      await expect(store.createTransaction(invalidTransaction as any))
        .rejects.toThrow('Category is required');

      const state = useTransactionStore.getState();
      expect(state.error).toBe('Category is required');
      expect(state.isLoading).toBe(false);
    });
    ...
    it('should throw error when account does not exist', async () => {
      ...
      await expect(store.createTransaction(invalidTransaction))
  ...
  describe('updateTransaction', () => {
    ...
    it('should throw error when transaction not found', async () => {
      ...
      await expect(store.updateTransaction('nonexistent', updates))
  ...
  describe('deleteTransaction', () => {
    ...
    it('should throw error when transaction not found', async () => {
      ...
      await expect(store.deleteTransaction('nonexistent'))
        .rejects.toThrow('Transaction not found');
