...
export function TransactionForm({
  ...
  const handleInputChange = (field: keyof Transaction, value: string | number | Date) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate form data
    const validationErrors = ValidationUtils.validateTransaction(formData as Transaction);
    ...
    <Card className="bg-card/60 backdrop-blur-sm border-border/50">
      ...
      <CardContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-2">
            ...
            {suggestedCategory && (
              <div className="flex items-center gap-2 p-2 bg-blue-50 dark:bg-blue-950 rounded border border-blue-200 dark:border-blue-800">
                ...
                >
                  {categories.find(c => c.id === suggestedCategory)?.name || 'Unknown'}
                </Badge>
                <Button
                  type="button"
                  variant="ghost"
          ...
          {/* Date */}
          <div className="space-y-2">
            <Label htmlFor="date" className="font-mono text-xs uppercase tracking-wider">
              Date *
            </Label>
            <Input
              id="date"
          ...
          {/* Note (Optional) */}
          <div className="space-y-2">
            <Label htmlFor="note" className="font-mono text-xs uppercase tracking-wider">
              Note (Optional)
            </Label>
            <Input
              id="note"
