...
export function TransactionFilters({
  ...
  const handleFilterChange = (key: keyof TransactionFiltersType, value: string | Transaction['type']) => {
    onFiltersChange({
      ...filters,
      [key]: value || undefined
    });
  ...
  const getActiveFiltersCount = () => {
    const basicFilters = [filters.category, filters.account, filters.type, searchTerm].filter(Boolean).length;
    const advancedFilters = [startDate, endDate, minAmount, maxAmount].filter(Boolean).length;
    ...
    <Card className="mb-6">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="w-full">
          <Label htmlFor="search" className="font-mono text-xs uppercase tracking-wider">
            Search
          </Label>
          <Input
            id="search"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            <Label htmlFor="account" className="font-mono text-xs uppercase tracking-wider">
              Account
            </Label>
            <Select
              id="account"
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Label htmlFor="type" className="font-mono text-xs uppercase tracking-wider">
              Type
            </Label>
            <Select
              id="type"
              value={filters.type || ''}
              onChange={(e) => handleFilterChange('type', e.target.value as Transaction['type'])}
              className="mt-1 text-base sm:text-sm"
              disabled={loading}
            >
        ...
        {showAdvanced && (
          <div className="border-t pt-4 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="endDate" className="font-mono text-xs uppercase tracking-wider">
                  End Date
                </Label>
                <Input
                  id="endDate"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="minAmount" className="font-mono text-xs uppercase tracking-wider">
                  Min Amount ($)
                </Label>
                <Input
                  id="minAmount"
              ...
              <div>
                <Label htmlFor="maxAmount" className="font-mono text-xs uppercase tracking-wider">
                  Max Amount ($)
                </Label>
                <Input
                  id="maxAmount"
