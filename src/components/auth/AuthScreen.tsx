...
type AuthFlow = 'selection' | 'pin-setup' | 'pin-login' | 'biometric-setup' | 'biometric-login';
        ...
        <Card className="w-full max-w-md">
          <CardContent className="flex items-center justify-center p-8">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-muted-foreground">Initializing authentication...</span>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            {authState && isAuthSetup(authState) ? 'Choose your authentication method' : 'Set up your preferred authentication method'}
          </p>
        </div>
...
function AuthMethodSelection({ biometricCapabilities, isSetup, onMethodSelect }: AuthMethodSelectionProps) {
        ...
        >
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">
              {isSetup ? 'Enter your PIN to continue' : 'Create a secure 6-digit PIN'}
            </div>
          </div>
        ...
        <div className="flex items-start space-x-3 p-4 bg-muted/50 rounded-lg">
          ...
          <div className="text-sm">
            ...
            <div className="text-muted-foreground">
              All authentication data is encrypted and stored locally on your device. 
