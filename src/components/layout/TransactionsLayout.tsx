 ...
 */
export function TransactionsLayout({ children, headerActions }: TransactionsLayoutProps) {
  return (
    <RouteLayout>
      <RouteHeader
        title="Transactions"
 ...
 */
export function TransactionsSection({ children, className }: TransactionsSectionProps) {
  return (
 ...
 */
export function TransactionsToolbar({ children, className }: TransactionsToolbarProps) {
  return (
 ...
 */
export function TransactionsContentGrid({ children, className }: TransactionsContentGridProps) {
  return (
