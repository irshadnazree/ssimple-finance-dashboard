...
describe('FinanceCalculations', () => {
  ...
  describe('calculateTotalIncome', () => {
    ...
    it('should return 0 for transactions with no income', () => {
      ...
      const income = FinanceCalculations.calculateTotalIncome(expenseOnlyTransactions);
    ...
    it('should filter by date range', () => {
      ...
      const income = FinanceCalculations.calculateTotalIncome(mockTransactions, startDate, endDate);
      expect(income).toBe(1000);
    });
  });
  ...
  describe('calculateTotalExpenses', () => {
    it('should calculate total expenses correctly', () => {
      const expenses = FinanceCalculations.calculateTotalExpenses(mockTransactions);
    ...
    it('should return 0 for transactions with no expenses', () => {
      ...
      const expenses = FinanceCalculations.calculateTotalExpenses(incomeOnlyTransactions);
  ...
  describe('calculateCashFlow', () => {
    ...
    it('should handle negative cash flow', () => {
      ...
      const cashFlow = FinanceCalculations.calculateCashFlow(negativeTransactions);
...
describe('ValidationUtils', () => {
  describe('validateTransaction', () => {
    ...
    it('should return errors for invalid amount', () => {
      ...
      const errors = ValidationUtils.validateTransaction(transaction);
      expect(errors.some(e => e.message === 'Amount must be positive')).toBe(true);
    });
