import type { Transaction, Budget, Account, ChartDataPoint } from '../../types/finance';
...
export namespace PerformanceOptimizer {
  ...
  export class ChartDataAggregator {
    ...
    public getAggregatedData(
      ...
      const aggregatedData = this.calculateAggregatedData(transactions, timeframe, type);
    ...
    private calculateAggregatedData(
      ...
      const filteredTransactions = type === 'both' 
        ? transactions 
...
export const transactionStore = new PerformanceOptimizer.MemoryEfficientStore<Transaction>(5000);
export const budgetStore = new PerformanceOptimizer.MemoryEfficientStore<Budget>(1000);